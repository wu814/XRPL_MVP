...
export default function SlippagePanel({ slippage, setSlippage, onClose }) {
  ...
  return (
    <div
      className={`absolute right-2 top-10 z-10 w-3/5 rounded-lg bg-color5 p-4`}
    >
      ...
      <div className="relative flex flex-row">
        <input
          ...
          className="relative w-full rounded-lg border border-border bg-color5 p-2 focus:border-primary focus:outline-none"
        />
