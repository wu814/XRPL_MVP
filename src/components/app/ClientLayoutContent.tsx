 ...
 export default function ClientLayoutContent({ children }: ClientLayoutContentProps) {
  ...
  const contentHeightClass = showNavigation ? "h-[calc(100vh-6rem)]" : "h-full";
   ...
   return (
     <div className="h-screen bg-color1 text-white overflow-hidden">
      ...
      <div
        className={`${showNavigation ? "mt-24 ml-56" : ""} ${showSmartTradePanel ? "mr-[30rem]" : ""} ${contentHeightClass} overflow-y-auto scrollbar-hide`}
      >
         {children}
       </div>
