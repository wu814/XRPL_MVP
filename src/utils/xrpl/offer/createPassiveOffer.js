 ...
 */
export default async function createPassiveOffer(wallet, takerPays, takerGets, destinationTag = null) {
  try {
    ...
    console.log("📜 Prepared Passive OfferCreate TX:", JSON.stringify(offerCreateTx, null, 4));
    ...
    if (response.result.meta.TransactionResult === "tesSUCCESS") {
      ...
      throw new Error(`Passive OfferCreate failed: ${response.result.meta.TransactionResult}`);
    }
  } catch (error) {
