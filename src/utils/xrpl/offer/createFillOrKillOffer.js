 ...
 */
export default async function createFillOrKillOffer(wallet, takerPays, takerGets, destinationTag = null) {
  try {
    ...
    console.log("📜 Prepared FillOrKill OfferCreate TX:", JSON.stringify(offerCreateTx, null, 4));
    ...
    if (response.result.meta.TransactionResult === "tesSUCCESS") {
      ...
      console.log(`ℹ️ Reason: Fill-or-Kill offers must be completely filled or they get cancelled`);
      ...
      throw new Error(`FillOrKill OfferCreate failed: ${response.result.meta.TransactionResult}`);
    }
  } catch (error) {
