...
const findBestPath = async (
  ...
  const sendMaxValue = new BigNumber(alternative.source_amount.value)
    .multipliedBy(1.01)
    .toString();
  const path = alternative.paths_computed ||
    alternative.paths_canonical ||
    alternative.paths || [[{ account: issuerAddress }]];
