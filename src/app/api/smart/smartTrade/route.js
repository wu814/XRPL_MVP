// This is calling the sendCrossCurrency function for smart trading
// Recipient is the same as sender (self-trade for conversion)
...
export async function POST(req) {
  try {
    ...
    return NextResponse.json(
      { error: `Smart trade failed: ${error.message}` },
      { status: 500 }
    );
  }
}
